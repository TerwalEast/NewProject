    ...
    <el-form ref="form" label-width="80px">
      ...
      <el-form-item label="标签设置">
        <el-checkbox-group v-model="article.labels">
          <el-checkbox v-for="(label,index) in labels" :label="label.text" :key="index" name="labels"></el-checkbox>
        </el-checkbox-group>
      </el-form-item>
...
export default {
  ...
  methods:{
    ...
    onSubmit(){
      this.article.labelIds = [];
      console.log(this.labels);
      for (var label of this.article.labels) {
        this.article.labelIds.push(this.labels.findIndex((value, index, obj) => {
